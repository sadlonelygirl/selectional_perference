...
"""
def printAll(path,flag):

    calculateSimAll(path+'writePhrases',path+'spellPhrases',path+'publishPhrases',flag)
    calculateSimAll(path+'providePhrases',path+'supplyPhrases',path+'leavePhrases',flag)
    calculateSimAll(path+'meetPhrases',path+'visitPhrases',path+'satisfyPhrases',flag)
    calculateSimAll(path+'runPhrases',path+'operatePhrases',path+'movePhrases',flag)
    calculateSimAll(path+'tryPhrases',path+'judgePhrases',path+'testPhrases',flag)
    calculateSimAll(path+'buyPhrases',path+'purchasePhrases',path+'bribePhrases',flag)
    calculateSimAll(path+'showPhrases',path+'expressPhrases',path+'picturePhrases',flag)
    calculateSimAll(path+'sayPhrases',path+'statePhrases',path+'allegePhrases',flag)
    calculateSimAll(path+'acceptPhrases',path+'bearPhrases',path+'receivePhrases',flag)
    calculateSimAll(path+'drawPhrases',path+'attractPhrases',path+'depictPhrases',flag)
"""
